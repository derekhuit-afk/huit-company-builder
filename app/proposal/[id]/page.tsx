    ...
    <main style={{minHeight:"100vh",background:"var(--obsidian)",padding:"60px 24px"}}>
      <div style={{maxWidth:820,margin:"0 auto"}}>
        ...
        <div style={{background:"linear-gradient(135deg,rgba(245,166,35,0.08),rgba(245,166,35,0.03))",border:"1px solid rgba(245,166,35,0.35)",borderRadius:18,padding:"32px 36px",textAlign:"center"}}>
          ...
          <a href="https://calendly.com/derekhuit" target="_blank" rel="noopener noreferrer" style={{display:"inline-block",background:"linear-gradient(135deg,#F5A623,#D4881A)",color:"#0A0A0B",padding:"14px 36px",borderRadius:10,fontSize:15,fontWeight:700,textDecoration:"none",marginBottom:12}}>Book Strategy Call →</a>
        ...
        <style>{`@media(max-width:640px){.paths-grid,.tools-grid,.mod-grid,.rc-grid{grid-template-columns:1fr!important}}`}</style>
      </div>
    </main>
  );
}
